...
public:
	...
	virtual int draw(double *y, int dim, const double *x, const gsl_rng* r, int B=0)=0;	// draw a sample to put into y given x
	virtual vector < double > draw (const vector <double > &x, const gsl_rng *r, int B=0)=0;
